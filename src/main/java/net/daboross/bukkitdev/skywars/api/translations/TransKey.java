...
public enum TransKey {
    ...
    // commands.setlobby
    CMD_SETLOBBY_DESCRIPTION("commands.setlobby.description", "Sets the lobby to your current location"),
    CMD_SETLOBBY_CONFIRMATION("commands.setlobby.confirmation", "&3The lobby is now at your current location."),
    // commands.setportal
    CMD_SETPORTAL_DESCRIPTION("commands.setportal.description", "Adds a portal at your current location"),
    ...
    CMD_DELPORTAL_CONFIRMATION("commands.delportal.confirmation", "&3Removed portal at &2%s&3."),
    ...
    CMD_VERSION_OUTPUT("commands.version.output", "&3%s version &2%s&3 / &2%s&3. Created by &2Dabo Ross&3."),
    // commands.lobby
    CMD_LOBBY_DESCRIPTION("commands.lobby.description", "Teleports you to the lobby"),
    CMD_LOBBY_CONFIRMATION("commands.lobby.confirmation", "&3Teleporting to the lobby."),
    ...
    SWS_START_DESCRIPTION("setup-commands.start.description", "Start a new arena setup and erase any previus unsaved arenas."),
    ...
    SWS_ADDSPAWN_CONFIRMATION("setup-commands.addspawn.confirmation", "&3Adding a new spawn location at &2%s&3."),
    // setup-commands.save
    ...
    SWS_SAVE_SAVED("setup-commands.save.saved", "&3Arena saved."),
    // top-commands
    ...
    TOO_MANY_PARAMS("generic-command-message.too-many-parameters", "&4Too many arguments."),
    // messages
