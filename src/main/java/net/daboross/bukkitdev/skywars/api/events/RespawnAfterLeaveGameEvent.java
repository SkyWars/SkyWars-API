...
public class RespawnAfterLeaveGameEvent extends PlayerEvent {
    ...
    public RespawnAfterLeaveGameEvent(SkyWars plugin, Player who) {
        super(who);
    ...
    public String toString() {
        return "RespawnAfterLeaveGameEvent{" +
                "plugin=" + plugin +
                ", player=" + player +
                '}';
    }
    ...
    public boolean equals(final Object o) {
        ...
        RespawnAfterLeaveGameEvent event = (RespawnAfterLeaveGameEvent) o;
